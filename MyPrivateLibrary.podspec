#
#  Be sure to run `pod spec lint MyPrivateLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/lgxemperor/MyPrivateLibrary.git", :tag => "#{s.version}" }
  ...
  # s.framework  = "SomeFramework"
   s.frameworks = "UIKit", "Foundation", "QuartzCore", "CoreLocation"
