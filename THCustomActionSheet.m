...
#import "THCustomActionSheet.h"

#define RGB(r, g, b)   [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1.0]

#define ColumnNum 4

@interface THCustomActionSheet()
{
    UIView *_backView;
}
@end

@implementation THCustomActionSheet
...
- (void) showInView:(UIView *)superView contentArray:(NSArray *)contentArray
{
    ...
    for (int i = 0; i < contentArray.count; i++) {
        ...
        THActionSheetButton *btn = [THActionSheetButton buttonWithType:UIButtonTypeCustom];
        btn.tag = i;
...
#pragma mark 按钮被点击了
- (void)btnClick:(THActionSheetButton *)btn{
