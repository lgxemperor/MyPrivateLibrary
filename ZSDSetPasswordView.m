...
- (void)initView
{
    ...
    _passwordTextField = [[UITextField alloc] initWithFrame:CGRectMake(0, 0, SCREENSIZE.width-80, kFieldSize.height)];
    ...
    CGFloat width = _passwordTextField.width / kDotCount;
